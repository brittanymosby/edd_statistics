...
This is due prior to the beginning of live session on the due date. Please submit your .Rmd file AND one knit file to the LMS. Round all reported statistics (when applicable) to the nearest hundredths place (i.e., two decimal places). Code chunks are provided for the responses that require an answer in code. Otherwise, please type your answers in plain text, using complete sentences where appropriate.

Please identify here any students with whom you worked on this assignment (MAX of four to a group):
...
Use the t-test function in R to confirm results in parts (c) and (d)
```{r}
